...
const VERSION_NOTIFICATION = {
  ...
  message: '✨ Исправлено: Хиджра, Вход в Google Accaunt, Меню сохранения и загрузки. Исправлено отоброжения Печати и PDF? Добавлено Выбор и сохронения своего логотипа в смете.'
};
